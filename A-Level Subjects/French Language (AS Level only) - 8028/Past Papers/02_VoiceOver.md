# Voice-Over Script: Past Papers (French Language (AS Level only) - 8028)

**[Visual: Upbeat, modern educational intro plays. The title card appears: "Cambridge French Language (AS Level only) - 8028: Past Papers. Welcome to Class!"]**

**Narrator (Upbeat and clear):**
"Welcome back, students! Today we are diving into an incredibly important area of your French Language (AS Level only) - 8028 syllabus: **Past Papers**. Understanding these core principles is absolutely essential for mastering the curriculum."
