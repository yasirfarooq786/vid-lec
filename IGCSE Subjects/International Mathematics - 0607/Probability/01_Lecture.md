# Complete Lecture: Probability (Cambridge IGCSE International Mathematics 0607)

**Probability** quantifies uncertainty using **0 to 1** (or 0% to 100%). Programme: [Cambridge IGCSE International Mathematics (0607)](https://www.cambridgeinternational.org/programmes-and-qualifications/cambridge-igcse-international-mathematics-0607/).
