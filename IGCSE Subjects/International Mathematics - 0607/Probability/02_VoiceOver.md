# Voice-Over Script: Probability (Cambridge IGCSE International Mathematics 0607)

**[Visual: Tree diagram two stages]**

**Narrator:**  
Probability needs a clear model: sample space, tree, or table—then multiply along branches carefully.
