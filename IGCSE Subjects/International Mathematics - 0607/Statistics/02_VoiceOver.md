# Voice-Over Script: Statistics (Cambridge IGCSE International Mathematics 0607)

**[Visual: Bar chart and frequency table]**

**Narrator:**  
Statistics is communication: choose the right chart and interpret the average in context.
