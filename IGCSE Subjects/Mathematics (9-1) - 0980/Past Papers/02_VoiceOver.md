# Voice-Over Script: Past Papers and Examination Technique (Cambridge IGCSE Mathematics (9–1) 0980)

**[Visual: Past paper, formula sheet, calculator with “check mode” sticker]**

**Narrator:**  
Past papers train **exam habits** for **0980**: reading constraints, showing working, and managing time across topics.
...
**Narrator:**  
Next: keep practising **timed papers**.
